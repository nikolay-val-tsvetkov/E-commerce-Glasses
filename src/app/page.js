  ...
  return (
    <div>
      <GlassesContextProvider>
        ...
        <div className='grid grid-rows-7 grid-cols-7 mt-44 sm:mt-40 mx-16  px-8 relative w-fit-content bg-slate-50/50 rounded-lg'>
          ...
          <div className='row-span-1 col-span-7 sm:col-span-2 mt-4 md:mr-16 justify-self-start sm:justify-self-end z-10'>
            <Sort />
          </div>
          ...
          <div className='flex flex-col sm:flex-row w-full justify-between row-span-1 col-span-7 py-4'>
            <Footer />
          </div>
        </div>
      </GlassesContextProvider>
